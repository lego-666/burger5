...
export const signupUser = (email, password) => {
  return function (dispatch) {
    ...
    axios
      .post(
        "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyA-ISGGclDEcbs3FYiKw7HtT6A5uCBpovU",
        data
      )
      .then((result) => {
...
export const autoLogoutAfterMillisec = (ms) => {
  return function (dispatch) {
    ...
    // axios
    //   .post(
    //     "https://securetoken.googleapis.com/v1/token?key=AIzaSyA-ISGGclDEcbs3FYiKw7HtT6A5uCBpovU",
    //     {
